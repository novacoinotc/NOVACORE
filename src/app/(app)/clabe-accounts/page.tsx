...
const defaultFormData: ClabeFormData = {
  id: '',
  companyId: '',
  clabe: '', // Only used for editing, OPM auto-generates for new accounts
  alias: '',
  description: '',
  isActive: true,
};
...
export default function ClabeAccountsPage() {
  ...
  const handleSave = async () => {
    // Validation - for new CLABEs, only company and alias are required (CLABE is auto-generated by OPM)
            ...
            >
              ...
              <div className="sticky top-0 z-10 bg-[#0a0a1a] border-b border-white/[0.06] px-6 py-4 flex items-center justify-between">
                <h2 className="text-lg font-semibold text-white flex items-center gap-2">
                  ...
                  {selectedClabe ? 'Editar Cuenta CLABE' : 'Generar Nueva Cuenta CLABE'}
                </h2>
                <button
                  onClick={() => setIsModalOpen(false)}
                  className="p-2 text-white/40 hover:text-white hover:bg-white/[0.05] rounded-lg transition-colors"
              ...
              <div className="p-6 space-y-4">
                ...
                {/* Auto-generation notice for new CLABEs */}
                {!selectedClabe && (
